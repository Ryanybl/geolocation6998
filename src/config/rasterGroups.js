...
const rasterGroups = [
	new RasterSourceGroup({
		...
		customNamesByMapboxId: {
			...
			['columbia-dataplatform.altp17rc']: 'Uganda Cropland cover fraction (2015)',  // updated using the previous id.
			['columbia-dataplatform.5y1gv038']: 'Uganda Road Density (2020)', // updated using the previous id.
		},
